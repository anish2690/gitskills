let app = new Vue({
        ...
        <div id="main">
            ...
            <div class="cart">
                ...
                <div class="pagination-container">
                    ...
                    <input type="text" style="text-align:center" ref="gotoInput"><button @click="goto">跳转</button>
    ...
    methods: {
        ...
        goto() {
            // this.$refs.gotoInput 拿到对应的绑定元素
            // 如果是原生标签，那么返回的原生的dom对象
            // console.log(this.$refs.gotoInput)

            // 如果是组件，那么存储的就是该组件的实例对象
            // console.log(this.$refs.kkbPagination)

            this.$refs.kkbPagination.changePage(this.$refs.gotoInput.value);
        }
    }
});
